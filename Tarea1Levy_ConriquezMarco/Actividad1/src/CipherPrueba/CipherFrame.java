...
import Codificar_descodificar.Descodificar;  //Otro archivo
...
//      BotonGuardarTxt.setBounds(100,100,50,50);
    ...
    private class HandlerDesencriptar implements ActionListener{
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            try {
                ...
                File file = new File("C:\\Users\\Marco\\OneDrive\\Documentos\\NetBeansProjects\\Tarea1Levy_ConriquezMarco\\Tarea1\\src\\DocumentosTxtyVeg\\Texto.txt");
  ...
  @Override
   public void actionPerformed(ActionEvent event) {
        try {
                archivo = new File("C:\\Users\\Marco\\OneDrive\\Documentos\\NetBeansProjects\\Tarea1Levy_ConriquezMarco\\Tarea1\\src\\ArchivosTXTyVEG\\Texto.txt");
